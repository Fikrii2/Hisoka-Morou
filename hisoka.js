...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            break
            case 'donasi': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/ebf0dbc68466885678e4a.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n ┌─「 Donasi  」
│ • Ovo: 0812-3373-8677
...
⭔ Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
            ...
            break
            case 'anime': case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': case 'waifus': case 'nekos': case 'trap': case 'hentai': case 'oral': case 'paizuri': case 'ecchi': case 'ero': case 'blowjob': {
                m.reply(mess.wait)
